...
class PacientesControllerTest < ActionController::TestCase
  ...
  test "should create paciente" do
    assert_difference('Paciente.count') do
      post :create, paciente: { email: @paciente.email, fone: @paciente.fone, idade: @paciente.idade, nome: @paciente.nome }
    end
  ...
  test "should update paciente" do
    patch :update, id: @paciente, paciente: { email: @paciente.email, fone: @paciente.fone, idade: @paciente.idade, nome: @paciente.nome }
    assert_redirected_to paciente_path(assigns(:paciente))
  end
